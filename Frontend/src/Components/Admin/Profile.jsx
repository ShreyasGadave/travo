  ...
  const handleChange = async (e) => {
    ...
    if (name === "idImg" && files && files[0]) {
      ...
      try {
        ...
        setFormData((prev) => {
          const updated = { ...prev, idImg: imageUrl };
      ...
      ${
        ...
        <div className="px-6 pb-6 -mt-12 relative z-10">
          <div className="flex items-center space-x-6">
            <img
              src="https://api.dicebear.com/6.x/initials/svg?seed=CJ"
              alt="avatar"
            ...
            <input
              ...
              readOnly={!isEditing}
              className="absolute left-35 text-white top-0 text-2xl md:text-3xl font-bold focus:outline-none focus:ring-0"
