...
const Profile = () => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-100 py-3 md:px-4 px-2">
        <div className="max-w-4xl mx-auto bg-white shadow-md rounded-lg overflow-hidden">
          <form onSubmit={handleSubmit}>
            <div className="md:h-32 h-24 bg-gradient-to-r from-blue-500 to-blue-300 relative backdrop-blur-lg">
              <button
                type="button"
      ...
      ${
        isEditing
          ...
          : "bg-white/10 hover:bg-white/20 backdrop-blur-md border border-white/30 shadow-md"
                    ...
                    typeof formData.profilePicture === "string" && (
                      <div className="relative w-fit mb-2">
                        <img
                          ...
                          alt="avatar"
                          className="md:w-34 md:h-34  h-34 w-28 rounded-full border-4 border-white shadow-md object-cover"
                        />
                        {uploading && (
            ...
            <div className="md:px-6 p-3 py-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
              {/* Contact Info */}
<div className="flex flex-col gap-1">
                <label className="text-gray-500 text-lg font-medium">Name </label>
                <input
                  type="text"
                  name="name"
                  value={formData.name ?? ""}
              ...
              <div className="flex flex-col gap-1">
                <label className="text-gray-500 text-lg font-medium">Email </label>
                <input
                  type="email"
                  name="email"
              ...
              <div className="flex flex-col gap-1">
                <label className="text-gray-500  text-lg font-medium">Phone</label>
                <input
                  type="text"
                  name="contact"
              ...
              <div className="flex flex-col gap-1">
                <label className="text-gray-500  text-lg font-medium">Alternate Phone</label>
                <input
                  type="text"
                  name="alternatePhone"
                  required
              ...
              {/* Address Info */}
              <div className="flex flex-col gap-1">
                <label className="text-gray-500  text-lg font-medium">Address </label>
                <input
                  type="text"
                  name="address"
                  required
              ...
              <div className="flex flex-col gap-1">
                <label className="text-gray-500  text-lg font-medium">City</label>
                <input
                  type="text"
                  name="city"
                  required
              ...
              <div className="flex flex-col gap-1">
                <label className="text-gray-500  text-lg font-medium">State</label>
                <input
                  type="text"
                  name="state"
                  required
              ...
              <div className="flex flex-col gap-1">
                <label className="text-gray-500  text-lg font-medium">District/Region</label>
                <input
                  type="text"
                  name="region"
                  required
              ...
              <div className="flex flex-col gap-1">
                <label className="text-gray-500  text-lg font-medium">Pin Code</label>
                <input
                  type="text"
                  name="pinCode"
                  required
              ...
              {/* Identity Details */}
              <div className="flex flex-col gap-1">
                <label className="text-gray-500  text-lg font-medium">Gender</label>
                <select
                  name="gender"
                  required
  ...
  <div className="flex flex-col">
    <label className="text-gray-500 text-lg font-medium">Role</label>
    <select
      name="role"
      required
      value={formData.role ?? ""}
    ...
    >
      ...
      <option value="Customer">Customer</option>
              ...
              <div className="flex flex-col gap-1">
                <label className="text-gray-500  text-lg font-medium">Date of Birth </label>
                <input
                  type="date"
                  required
                  name="dob"
              ...
              <div className="flex flex-col gap-1">
                <label className="text-gray-500  text-lg font-medium">ID Proof Type:</label>
                <select
                  name="idProofType"
              ...
              <div className="flex flex-col gap-1">
                <label className="text-gray-500  text-lg font-medium">ID Proof Number</label>
                <input
                  type="text"
                  name="idProofNumber"
              ...
              <div className="flex flex-col gap-1">
                <label className="text-gray-500  text-lg font-medium">Upload ID Proof</label>
              ...
              <div className="flex flex-col gap-1 sm:col-span-2">
                <label className="text-gray-500  text-lg font-medium">Short Bio</label>
                <textarea
                  name="bio"
                  value={formData.bio}
                  onChange={handleChange ?? ""}
