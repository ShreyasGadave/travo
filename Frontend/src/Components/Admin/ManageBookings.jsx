...
const ManageBookings = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        if (!admin?.adminId) return; // wait until admin is ready
        ...
        setBookingData(res.data); // ✅ save to state
      } catch (error) {
        console.log("Error fetching bookings:", error);
      }
    };
    ...
    fetchData();
  }, [admin]); // refetch when admin changes
                ...
                <div className="p-4 space-y-8">
                  ...
                  <div className="  rounded-2xl shadow-lg border border-gray-200 hover:shadow-xl transition duration-300">
                    ...
                    <div className="w-full h-full  overflow-hidden ">
                      <AgentMap
                        location_lat={
                          selectedBooking.carDetails.pickupLocation.lat
                        }
                        location_lng={
                          selectedBooking.carDetails.pickupLocation.lng
                        }
                      />
                    </div>
                  </div>
